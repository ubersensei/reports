...
const createReportItemsByReportId = (n_items, reportId) => {
    ...
    state.reportsItemsTasksStatus = JSON.parse( JSON.stringify(reportsItemsTasksStatus));
    state.reportsItemsComments = JSON.parse(JSON.stringify(reportsItemsComments));

    console.log(JSON.stringify(reportsItemsComments));
